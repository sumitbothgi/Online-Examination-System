...
<center><h1><%= name.toUpperCase() %> TEST</h1></center>
<hr>
...
<br> 	
	<center><a href="updateQuestion.jsp?id=<%=d.getQuesId()%>&name=<%=name %>&adminName=<%=request.getAttribute("adminData") %>" class="btn btn-primary">Update</a></center>
</div>
<br>
<%}} %>
</div>
